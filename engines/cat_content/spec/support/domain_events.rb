...
module DomainEventHelpers
  ...
  def capture_domain_events
    ...
    allow_any_instance_of(HexDDD::Domain::AggregateRoot).to receive(:apply) do |instance, event|
      events << event
  ...
  #
  # @param aggregate [HexDDD::Domain::AggregateRoot]
  # @return [Array<HexDDD::Domain::DomainEvent>]
  #
