...
module CatContent
  module Events
    class CatListingPublished < HexDDD::Domain::DomainEvent
      SCHEMA_VERSION = 1
...
module CatContent
  module Events
    class CatListingArchived < HexDDD::Domain::DomainEvent
      SCHEMA_VERSION = 1
...
module CatContent
  module Events
    class CustomCatCreated < HexDDD::Domain::DomainEvent
      SCHEMA_VERSION = 1
...
module CatContent
  module Events
    class CustomCatArchived < HexDDD::Domain::DomainEvent
      SCHEMA_VERSION = 1
...
module CatContent
  module Events
    class CatDescriptionRegenerated < HexDDD::Domain::DomainEvent
      SCHEMA_VERSION = 1
...
module CatContent
  module Ports
    class CustomCatRepository < HexDDD::Ports::SecondaryPort
...
module CatContent
  module Ports
    class LanguageModelPort < HexDDD::Ports::SecondaryPort
...
module CatContent
  module Ports
    class MediaStoragePort < HexDDD::Ports::SecondaryPort
      abstract_method :upload, :get_url, :delete
    end

    class SearchIndexPort < HexDDD::Ports::SecondaryPort
      abstract_method :index, :search, :remove
    end

    class ClockPort < HexDDD::Ports::SecondaryPort
      abstract_method :now
    end

    class IdGeneratorPort < HexDDD::Ports::SecondaryPort
      abstract_method :generate
    end

    class TransactionPort < HexDDD::Ports::SecondaryPort
...
module CatContent
  module Commands
    class CreateCatListingCommand < HexDDD::Application::Command
      attribute :name, Types::String
...
module CatContent
  module Commands
    class GenerateCustomCatCommand < HexDDD::Application::Command
      attribute :user_id, Types::String
...
module CatContent
  module Commands
    class ArchiveCustomCatCommand < HexDDD::Application::Command
      attribute :custom_cat_id, Types::String
...
module CatContent
  module Queries
    class ListCustomCatsQuery < HexDDD::Application::Query
      attribute :user_id, Types::String
