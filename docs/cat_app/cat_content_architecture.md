...
This is the complete HexDDD component map for the **Cat & Content bounded context only**, derived from the bounded context diagram, HexDDD architecture, and functional spec.
