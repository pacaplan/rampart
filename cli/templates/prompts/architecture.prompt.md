...
Before starting, determine whether you're creating a new bounded context or modifying an existing one.
...
4. Ask what changes they want to make (see "Modification Workflow" below)
...
**Before designing, ask the user for any materials that inform the domain.**
